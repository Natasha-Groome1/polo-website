...
const gridTeam = () => (
  <Grid columns={4} divided>
    ...
    <Grid.Row>
      <Grid.Column>
        <Segment size="large">Level 2 HPA Coach</Segment>
      </Grid.Column>
      <Grid.Column>
        <Segment size="large">Academy Manager</Segment>
      </Grid.Column>
      <Grid.Column>
        <Segment size="large">Head Groom</Segment>
      </Grid.Column>
      <Grid.Column>
        <Segment size="large">Groom</Segment>
      </Grid.Column>
    </Grid.Row>
  </Grid>
);
